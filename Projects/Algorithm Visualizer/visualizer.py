...
def switch_demo(arg):
	...
	1 : sys.argv.append("SelectionSort"),
	2 : sys.argv.append("BubbleSort")
	}
'''
if __name__ == "__main__":
    '''
    print("Enter your choice to see which algorithm")
    ...
    switch_demo(x)
    ''' 
    # x = {1:"SelectionSort", 2:"BubbleSort", 3:"InsertionSort", 4:"MergeSort", 5:"QuickSort"}
    # while(True):
